...
const args=['deploy',process.env.GRAPH_SUBGRAPH_SLUG ?? 'margit-arc','subgraph/subgraph.yaml','--node','https://api.studio.thegraph.com/deploy/','--deploy-key',key,'--version-label',process.env.GRAPH_VERSION ?? 'v0.1.0','--output-dir','subgraph/build'];
