        ...
        <div className="mxd-hero-00__wrap">
            ...
            <div className="mxd-hero-00__title-wrap loading-wrap">
              ...
              <div className="mxd-hero-00__marquee loading__item">
                <div className="marquee marquee-left--gsap">
                  <MarqueeTrack className="marquee__toleft marquee-flex">
              ...
              <h1 className="hero-00-title">
                ...
                <span className="hero-00-title__row loading__item">
                  ...
                  <em className="hero-00-title__item">{"on GitHub"}</em>
                </span>
              </h1>
            </div>
          </div>
          ...
          <div className="mxd-hero-00__bottom">
            <div className="hero-00-manifest loading__fade">
              <p className="mxd-manifest reveal-type anim-uni-in-up"><RevealText underline="AI agent" text={"Margit is a marketplace for private repositories. Get paid in USDC or EURC on Arc — buyers, human or AI agent, pay once and get an authenticated clone."} /></p>
            </div>
          </div>
        </div>
      </div>
