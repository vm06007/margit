        ...
        <div className="mxd-block">
          <div className="mxd-demo-list">
            ...
            <div className="mxd-demo-list__row">
              ...
              <a className="mxd-demo-list__item animate-card-3" href="index-creative-design-studio.html" target="_blank">
                <div className="mxd-demo-list__image">
                  <img src="/site/img/demo/screens/05.webp" alt="Margit Demo Screen" />
                  <div className="mxd-demo-list__screen screen-05"></div>
                </div>
                <div className="mxd-demo-list__caption">
                  <span className="mxd-demo-list__link small">{"Creative Design Studio"}</span>
